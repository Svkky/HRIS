...
namespace HRIS.WebUI.Services
{
    public class HttpClientService : IHttpClientService
    {
        ...
        public async Task<T> GetAsync<T>(string uri, string authToken, string branchId)

        {
            try
            {
                HttpClient httpClient = CreateHttpClient(authToken, branchId);
        ...
        private HttpClient CreateHttpClient(string authToken = "", string branchId = "")
        {
            ...
            {
                httpClient.DefaultRequestHeaders.Add("branchId", branchId);
            }
